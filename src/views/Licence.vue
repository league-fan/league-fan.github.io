<template>
  ...
  <p>
    ...
    <br />However: Riot Games allows use of their League of Legends intellectual property when meeting the conditions lined in their Legal Jibber-Jabber policy.
    <br />This Website believes usage falls under US fair-use law because:
    <br />
