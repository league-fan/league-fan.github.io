...
export const languageZoneToName: Partial<Record<LanguageZone, string>> = {
  ...
  [LanguageZone.ChineseTaiwan]: "中文（繁體）",
  [LanguageZone.ChineseChina]: "中文（简体）",
  [LanguageZone.ChineseMalaysia]: "中文（马来西亚）",
  ...
  [LanguageZone.EnglishSingapore]: "English-Singapore",
  [LanguageZone.EnglishPhilippines]: "English-Philippines",
  [LanguageZone.EnglishGreatBritain]: "English-GreatBritain",
  [LanguageZone.EnglishAustralia]: "English-Australia",
...
export const bcp47ToLanguageZone: Record<string, LanguageZone> =
  Object.fromEntries(
    Object.entries(languageZoneToBCP47).map(([key, value]) => [
      value,
      key as LanguageZone,
    ]),
  );
